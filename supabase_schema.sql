...
INSERT INTO trades (id, post_id, carrier_id, shipper_id, item_name, item_weight, status, carrier_completed, shipper_completed) VALUES
  ('t1111111-1111-1111-1111-111111111111', NULL, '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'Aptamil', 3, 'completed', TRUE, TRUE),
  ('t2222222-2222-2222-2222-222222222222', NULL, '11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'Documents', 0.5, 'completed', TRUE, TRUE),
  ('t3333333-3333-3333-3333-333333333333', NULL, '11111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-555555555555', 'Watch', 0.2, 'completed', TRUE, TRUE);

INSERT INTO trust_tag_votes (trade_id, voter_id, recipient_id, tag_id) VALUES
  -- Linda votes for 张明
  ('t1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'smooth_comm'),
  ('t1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'on_time'),
  ('t1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'careful_pack'),
  -- 李华 votes for 张明
  ('t2222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', 'smooth_comm'),
  ('t2222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', 'on_time'),
  -- 王芳 votes for 张明
  ('t3333333-3333-3333-3333-333333333333', '55555555-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111', 'smooth_comm'),
  ('t3333333-3333-3333-3333-333333333333', '55555555-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111', 'on_time');
